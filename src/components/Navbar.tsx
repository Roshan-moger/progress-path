  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <Link to="/" className="flex items-center gap-2 sm:gap-3 font-heading text-xl sm:text-2xl font-black tracking-tight group flex-shrink-0">
        ...
        <div className="hidden md:flex items-center gap-6 lg:gap-8 text-xs sm:text-sm font-medium text-muted-foreground">
          ...
          <Link to="/admin-login" className="hover:text-primary transition-colors duration-200">Employers</Link>
        </div>
