...
const StudentLogin = () => {
  ...
  return (
    <div className="min-h-screen gradient-hero flex items-center justify-center p-6">
      ...
      >
        <Link to="/" className="font-heading text-2xl font-bold text-primary block mb-2">Vyona.</Link>
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          Are you an admin? <Link to="/admin-login" className="text-primary font-medium hover:underline">Login here</Link>
        </p>
      </motion.div>
    </div>
  );
